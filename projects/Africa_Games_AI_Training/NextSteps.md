...
2. **Playtest on real phones in Nairobi** — with both generations. Two things the automated tests cannot judge: whether the **animal calls grate** over a long session, and a **live duel between two phones on mobile data**.
...
| Item | Date | Notes |
|---|---|---|
| Nairobi Wild v0.3 — animal calls, 51 African city stages, production monetization module | 2026-08-30 | 67/67 tests; shop, purchase and call synthesis verified in-browser |
