...
|---|---|---|
| **Nairobi Wild** ⭐ *flagship* | Match-3 puzzle in the Candy Crush mould, made in Nairobi. Animals that call when you match them, **51 African city stages**, a synthesised Benga soundtrack, offline solo play and **live online duels**. | ✅ Playable v0.3, 67/67 tests |
...
- **It runs on the phones people actually have.** ~123 KB, fully offline, no image or audio assets at all — every animal call and every note of music is synthesised at runtime.

## Ways to play

| Mode | Needs a network? |
|---|---|
| Safari — 51 stages, Nairobi to Cape Town | No |
