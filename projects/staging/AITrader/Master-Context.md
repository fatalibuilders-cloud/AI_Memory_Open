...
- **Trading Modes:**
  - **Safe Mode:** Only takes trades the EA's internal signal-confidence filter rates at 80–100% historical win probability. Lower trade frequency, prioritizes high-confidence setups. Internal daily target: **5%** (founder-confirmed, 2026-07-14l — top of the 1–5% recommended range for this mode). ⚠️ Flagged: the filter's 80% floor may not clear the ≥$50 stop-loss tier's 85.7% break-even requirement — needs backtest validation (see Open Questions).
