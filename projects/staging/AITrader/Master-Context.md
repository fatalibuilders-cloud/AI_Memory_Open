...
- **EA core (MQL5):** The trading algorithm itself, written in MQL5 for MetaTrader 5. Includes:
  ...
  - Dual-mode profit-lock exit logic: (a) outright close, or (b) move stop to breakeven and let the position run. Both exit modes configurable/testable. **Target dollar amount now differs by trading mode — see Trading Modes below** (Aggressive Mode: percentage of equity; Safe Mode: $0.30 flat, both tiers, 2026-07-14zz).
