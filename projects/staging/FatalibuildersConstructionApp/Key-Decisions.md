...
- **2026-07-16 (1026, CURRENT — STANDARDS BASELINE):** Owner confirmed the governing codes: **Eurocodes (EN 1990-1999) + British Standards + US codes + KEBS/Kenya profile**, implemented as per-project **code profiles** (Eurocode+BS rule-sets first). EN 1997 / BS 8004 govern the geotech report; every output stamps its code profile. **Kenya inferred as primary market (pending confirmation)** → M-Pesa payment support likely required — see `decisions-learnings/Key-Decisions-2026-07-16_1026.md`.
