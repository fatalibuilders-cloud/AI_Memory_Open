...
| 2026-07-16 | standards, Eurocodes, British Standards, US codes, KEBS, Kenya, code profile, M-Pesa | `decisions-learnings/Key-Decisions-2026-07-16_1026.md` | Standards baseline confirmed: per-project code profiles (Eurocode + BS first, US later, Kenya/KEBS profile); Kenya inferred as primary market (M-Pesa payment implications) — confirmation pending |
| 2026-07-16 | worldwide market, Kenya launch, residential, management features, staging complete, tech stack | `decisions-learnings/Key-Decisions-2026-07-16_1030.md` | Final staging answers: worldwide product launched from Kenya; R1 = residential; management features stay (R4). All three staging documents completed (Docs 2-3 pending sign-off) |
...
- **2026-07-16 (1030, CURRENT — STAGING COMPLETE):** Final answers: **worldwide product launched from Kenya** (dual payment stack: global cards + M-Pesa); **R1 = residential buildings**; **management features confirmed → R4**. Document 1 COMPLETE; Documents 2 & 3 DRAFT COMPLETE (AI-proposed stack: PWA, Next.js/TypeScript/PostgreSQL, SVG/three.js engines) pending owner sign-off. Next: "Initialize FatalibuildersConstructionApp via PROJECT_MEMORY_INIT.md" — see `decisions-learnings/Key-Decisions-2026-07-16_1030.md`.
- **2026-07-16 (1026 — STANDARDS BASELINE):** Owner confirmed the governing codes: **Eurocodes (EN 1990-1999) + British Standards + US codes + KEBS/Kenya profile**, implemented as per-project **code profiles** (Eurocode+BS rule-sets first). EN 1997 / BS 8004 govern the geotech report; every output stamps its code profile. **Kenya inferred as primary market (pending confirmation)** → M-Pesa payment support likely required — see `decisions-learnings/Key-Decisions-2026-07-16_1026.md`.
- **2026-07-16 (1019 — CORE TOOL DEFINED):** Owner confirmed the full output set: **material quantities, cost estimate, labor/time estimate, 2D drawings, renders, structural drawings, geotechnical report (from soil type)**. Engineering outputs (structural/geotech) will be watermarked "preliminary — requires licensed engineer review" with legal sign-off before their release. Phasing: R1 = calculators + payment + exports; R2 = drawings/renders; R3 = engineering outputs. Open: management features (Epic 8), market/country + building codes, Release-1 construction types — see `decisions-learnings/Key-Decisions-2026-07-16_1019.md`.
