 ...
 * - DATABASE_URL set  → managed PostgreSQL (production / CORE-1.2 onward)
 * - DATABASE_URL unset → embedded PGlite: in-memory under test, on-disk
 *   at .pglite/ for local development. Same Postgres dialect everywhere.
 */
